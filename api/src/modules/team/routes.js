...
function createTeamRouter({
  ...
  router.get("/team/members", async (req, res) => {
    ...
    res.json(ok(await buildTeamMembers()));
  });
  ...
  router.post("/users", requirePermission("admin:*"), async (req, res) => {
    ...
    const selectedDepartment = requestedDepartmentId
      ? await organizationRepository?.findUnit(requestedDepartmentId)
      : requestedDepartmentName ? await organizationRepository?.findUnitByName(requestedDepartmentName) : null;
