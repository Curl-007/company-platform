  ...
  return (
    <Panel title={t('features.settings.aiAssistantPanel.title')} subtitle={t('features.settings.aiAssistantPanel.subtitle')}>
      <div className="settings-form detail-sections">
        ...
        {/* 助手运行状态 */}
        <section className="detail-section" aria-label={t('features.settings.aiAssistantPanel.statusTitle')}>
          <div className="detail-section-header">
            <span>{t('features.settings.aiAssistantPanel.statusTitle')}</span>
          </div>
            ...
            {aiAssistantLoading ? (
              ...
              <div className="detail-strip">
                <div className="detail-strip-item">
                  <span className="detail-strip-label">{t('features.settings.aiAssistantPanel.enabledLabel')}</span>
                  <span className="detail-strip-value">
                    <StatusBadge
                      label={aiAssistant?.enabled ? t('features.settings.aiAssistantPanel.enabled') : t('features.settings.aiAssistantPanel.disabled')}
                      status={aiAssistant?.enabled ? 'success' : 'neutral'}
                      showDot
                    />
                  </span>
                </div>
                <div className="detail-strip-item">
                  <span className="detail-strip-label">{t('features.settings.aiAssistantPanel.modelLabel')}</span>
                  <span className="detail-strip-value text-mono">
                    {aiAssistant?.resolvedModel || selectedModel || t('features.settings.aiAssistantPanel.useConnectionDefault')}
                  </span>
                </div>
                <div className="detail-strip-item">
                  <span className="detail-strip-label">{t('features.settings.aiAssistantPanel.connectionLabel')}</span>
                  <span className="detail-strip-value">
                    {selectedProvider?.name || selectedProvider?.provider || t('features.settings.aiAssistantPanel.useActiveConnection')}
                  </span>
                </div>
              </div>
            )}
        ...
        {/* 基本信息 */}
        <section className="detail-section" aria-label={t('features.settings.aiAssistantPanel.basicTitle')}>
          <div className="detail-section-header">
            <span>{t('features.settings.aiAssistantPanel.basicTitle')}</span>
          </div>
          <div className="detail-section-body">
        ...
        {/* 模型绑定 */}
        <section className="detail-section" aria-label={t('features.settings.aiAssistantPanel.modelTitle')}>
          <div className="detail-section-header">
            <span>{t('features.settings.aiAssistantPanel.modelTitle')}</span>
          </div>
          <div className="detail-section-body">
            <div className="form-row">
        ...
        {/* 生成参数 */}
        <section className="detail-section" aria-label={t('features.settings.aiAssistantPanel.paramsTitle')}>
          <div className="detail-section-header">
            <span>{t('features.settings.aiAssistantPanel.paramsTitle')}</span>
          </div>
          <div className="detail-section-body">
            <div className="form-row">
